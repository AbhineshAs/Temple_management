      ...
      <div className="about-page">
        ...
        <div className="gold-card" data-ani="left">
          ...
          <p>
            ...
            ക്ഷേത്രമാണ് പാങ്ങോട് കാവിൽ ശ്രീ ഭഗവതി ക്ഷേത്രം. തിരുവനതപുരം
            പാങ്ങോടിനും ഇടപ്പഴിഞ്ഞിക്കും ഇടയിൽ സ്‌ഥിതിചെയ്യുന്ന ഒരു പ്രശസ്തമായ
            തീർത്ഥാടന കേന്ദ്രമാണ്. കുടുംബാംഗങ്ങളുടെയും പൊതുജനങ്ങളുടെയും സഹകരണവും
            നിദാന്ത പരിശ്രമവും കൊണ്ട് ക്ഷേത്രം നാൾക്കുനാൾ അഭിവൃദ്ധിപ്പെട്ട്
            പ്രശസ്തി ആർജ്ജിക്കുകയും ദേവിയുടെ അനുഗ്രഹത്താൽ എല്ലാ ഭക്തജനങ്ങൾക്കും
            അഭിവൃദ്ധിയും കുടുംബ ഐശ്വര്യവും ഒത്തൊരുമയും ഉണ്ടായികൊണ്ടിരിക്കുകയാണ്.
            ... (your full text continues)
          </p>
        </div>
